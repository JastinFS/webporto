...
export default function Skills() {
  ...
  return (
    ...
    >
      ...
      <p className="skills__hint">{SKILLS.hint}</p>
        ...
        {CARDS.map((sk, i) => {
          ...
          return (
            <div
              ...
              onClick={() => setFlipped((f) => (f === sk.id ? null : sk.id))}
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
                if (e.key === 'Enter' || e.key === ' ') {
                  e.preventDefault();
                  setFlipped((f) => (f === sk.id ? null : sk.id));
                }
              }}
              ...
              <div className="arcana__inner" style={innerStyle}>
                <div className="arcana__face arcana__front">
                  <div className="arcana__art">
                    {bg ? <img src={bg} alt="" /> : <div className="arcana__art-fallback" />}
                  </div>
